...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[108];   //[nGenPart]
   Float_t         GenPart_mass[108];   //[nGenPart]
   Float_t         GenPart_phi[108];   //[nGenPart]
   Float_t         GenPart_pt[108];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[108];   //[nGenPart]
   Int_t           GenPart_pdgId[108];   //[nGenPart]
   Int_t           GenPart_status[108];   //[nGenPart]
   Int_t           GenPart_statusFlags[108];   //[nGenPart]
...
#ifdef MainEvent_cxx
MainEvent::MainEvent(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("testfile/GluGluToHHTo2B2G_node_cHHH1_TuneCP5_PSWeights_13TeV-powheg-pythia8_Nano02Apr2020_24B37EBE-E184-9D40-A241-3DB4340E32B7.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("testfile/GluGluToHHTo2B2G_node_cHHH1_TuneCP5_PSWeights_13TeV-powheg-pythia8_Nano02Apr2020_24B37EBE-E184-9D40-A241-3DB4340E32B7.root");
      }
...
Int_t MainEvent::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MainEvent::LoadTree(Long64_t entry)
{
...
void MainEvent::Show(Long64_t entry)
{
...
Int_t MainEvent::Cut(Long64_t entry)
{
