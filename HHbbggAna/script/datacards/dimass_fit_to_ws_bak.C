...
void gauss_fit(string rt_file_name, string rt_file_path, string obs_var){
    ...
    */
    ...
    TString output_file = path+"hhbbgg.gauss."+rt_file_path+".input.root";

    RooWorkspace *w = new RooWorkspace("combined","workspace") ;    
    w->import(*model);
    w->Print();
...
void CB_fit(string rt_file_name, string rt_file_path, string obs_var)
{
    ...
    */
    ...
    TString output_file = path+"hhbbgg.CB."+rt_file_path+".input.root";
...
void dimass_fit_to_ws(){
     ...
     string names_90_ggHH [15] = {"glu_glu_to_HH_signal_90_ggHHCat", "VBF_to_HH_signal_90_ggHHCat", 
            "VH_to_GG_90_ggHHCat", "ttH_to_GG_90_ggHHCat", "VBFH_to_GG__90_ggHHCat", "glu_glu_H_to_GG_90_ggHHCat",
        "tt_jets_90_ggHHCat", "ttg_jets_90_ggHHCat", "ttgg_jets_90_ggHHCat",
        "gjet_small_pt_90_ggHHCat", "gjet_big_pt_90_ggHHCat", "diphoton_jets_box_90_ggHHCat", "diphoton_jets_box_1B_90_ggHHCat", 
                                  "diphoton_jets_box_2B_90_ggHHCat", "qcd_90_ggHHCat"};
    ...
    string paths_90_ggHH [15] = {"90_combine_ggHH_GluGluToHH_sig_file", "90_combine_ggHH_VBFHH_sig_file", "90_combine_ggHH_VHToGG_file",
     ...
     string names_90_vbfHH [15] = {"glu_glu_to_HH_signal_90_VBFHHcat", "VBF_to_HH_signal_90_VBFHHcat", 
            "VH_to_GG_90_VBFHHcat", "ttH_to_GG_90_VBFHHcat", "VBFH_to_GG_90_VBFHHcat", "glu_glu_H_to_GG_90_VBFHHcat",
        "tt_jets_90_VBFHHcat", "ttg_jets_90_VBFHHcat", "ttgg_jets_90_VBFHHcat",
        "gjet_small_pt_90_VBFHHcat", "gjet_big_pt_90_VBFHHcat", "diphoton_jets_box_90_VBFHHcat", "diphoton_jets_box_1B_90_VBFHHcat", "diphoton_jets_box_2B_90_VBFHHcat", "qcd_90_VBFHHcat"};
