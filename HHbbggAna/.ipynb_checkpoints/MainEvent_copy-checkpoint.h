...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[121];   //[nGenPart]
   Float_t         GenPart_mass[121];   //[nGenPart]
   Float_t         GenPart_phi[121];   //[nGenPart]
   Float_t         GenPart_pt[121];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[121];   //[nGenPart]
   Int_t           GenPart_pdgId[121];   //[nGenPart]
   Int_t           GenPart_status[121];   //[nGenPart]
   Int_t           GenPart_statusFlags[121];   //[nGenPart]
   ...
   Float_t         Jet_corr_JMS[24];   //[nJet]
   Float_t         Jet_corr_JMR[24];   //[nJet]
   Float_t         MET_pt_nom;
   Float_t         MET_phi_nom;
   Float_t         Jet_pt_jerUp[24];   //[nJet]
   Float_t         Jet_mass_jerUp[24];   //[nJet]
   Float_t         Jet_mass_jmrUp[24];   //[nJet]
   Float_t         Jet_mass_jmsUp[24];   //[nJet]
   ...
   Float_t         Jet_mass_jmrDown[24];   //[nJet]
   Float_t         Jet_mass_jmsDown[24];   //[nJet]
